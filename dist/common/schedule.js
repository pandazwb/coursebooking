...
const getRowClassList = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = {
            "StoresID": "1517",
            "isweek": "0",
        ...
        const res = yield fetch("https://test.xingxingzhihuo.com.cn/WebApi/getListRowClassNew.aspx", {
            "headers": {
        ...
        for (let index = 0; index < courseList.length; index++) {
            ...
            if (diff > -0 && diff < 60) {
                ...
                const afterPrice = yield calPrice(item);
...
const calPrice = (course) => __awaiter(void 0, void 0, void 0, function* () {
    const db = yield (0, db_1.getDb)();
    // TODO: 这里需要一个策略来计算价格
    // 1.获取当前课程的价格
    const sql = `SELECT * FROM price_range`;
    // res  [ { discount: '1', amount: 3, price: 0 } ]
    const res = yield db.all(sql);
    console.log('res', res);
    return course.singlePrice;
});
const getPreAboutList = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield fetch("https://test.xingxingzhihuo.com.cn/WebApi/getListPreAbout.aspx", {
        "headers": {
            "accept": "application/json",
            "accept-language": "zh-CN,zh;q=0.9,ja;q=0.8",
            "access-control-allow-origin": "*",
...
const modifyPrice = (body, curPrice = '500') => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield fetch("https://test.xingxingzhihuo.com.cn/WebApi/editRowClass.aspx", {
        "headers": {
            "accept": "application/json",
            "accept-language": "zh-CN,zh;q=0.9,ja;q=0.8",
            "access-control-allow-origin": "*",
    ...
    if (json.orsuccess && json.orsuccess == 1) {
        const db = yield (0, db_1.getDb)();
        yield db.run(`INSERT INTO update_history (updateTime,prePrice,curPrice,courseName,courseID) VALUES (?,?,?,?,?)`, [
            (0, db_1.formatToLocalTime)(Date.now()),
            prePrice,
            curPrice,
            body.CourseName,
            body.CourseID,
